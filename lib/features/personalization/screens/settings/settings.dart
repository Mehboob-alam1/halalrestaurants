      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            HProfileMenuIcon(icon: Iconsax.lock_1, text: 'Password', onPressed: () => Get.to(()=>const ResetPasswordScreen())),
            ...
            HProfileMenuIcon(text: 'Logout',icon: Iconsax.logout, onPressed: ()=> AuthenticationRepository.instance.logout())
          ],
        ),
      ),
    );
